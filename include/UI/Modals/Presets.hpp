...
DECLARE_CLASS_CODEGEN_INTERFACES(BetterSongSearch::UI::Modals, Presets, UnityEngine::MonoBehaviour, classof(HMUI::TableView::IDataSource*),
    ...
    DECLARE_INSTANCE_FIELD(StringW, newPresetName);
